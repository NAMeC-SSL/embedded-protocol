...
#define RadioCommand_init_zero                   {0, 0, 0, 0, _Kicker_MIN, 0, 0, 0, 0}

/* Field tags (for use in manual encoding/decoding) */
#define RadioCommand_robot_id_tag                1
#define RadioCommand_normal_velocity_tag         2
#define RadioCommand_tangential_velocity_tag     3
#define RadioCommand_angular_velocity_tag        4
#define RadioCommand_kick_tag                    5
#define RadioCommand_kick_power_tag              6
#define RadioCommand_charge_tag                  8
#define RadioCommand_dribbler_tag                9
#define RadioCommand_dev_tag                     10

/* Struct field encoding specification for nanopb */
#define RadioCommand_FIELDLIST(X, a) \
...
X(a, STATIC,   SINGULAR, BOOL,     dev,              10)
#define RadioCommand_CALLBACK NULL
#define RadioCommand_DEFAULT NULL

extern const pb_msgdesc_t RadioCommand_msg;

/* Defines for backwards compatibility with code written before nanopb-0.4.0 */
#define RadioCommand_fields &RadioCommand_msg

/* Maximum encoded size of messages (where known) */
#define RadioCommand_size                        37
